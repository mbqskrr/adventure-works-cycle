...
class ProductsubcategoryTest {
	...
	/*
	 * private Productsubcategory psc; private Productcategory pc; private
	 * SimpleDateFormat df; private Date date; private long time1; private Timestamp
	 * time; //private List<Product> products;
	 * 
	 * @Mock private ProductsubcategoryRepository productsubcategoryRepository;
	 * 
	 * @Mock private ProductcategoryRepository productcategoryRepository;
	 * 
	 * @InjectMocks private ProductsubcategoryServiceImpl productsubcategoryService;
	 * 
	 * @BeforeAll static void start() { System.out.println("... TEST STARTED ...");
	 * }
	 * 
	 * @BeforeEach void setUp() throws ParseException { //products = new
	 * ArrayList<Product>(); psc = new Productsubcategory(); pc = new
	 * Productcategory(); df = new SimpleDateFormat("dd-MM-yyyy"); date =
	 * df.parse("27-03-2022"); time1 = date.getTime(); time = new Timestamp(time1);
	 * }
	 * 
	 * 
	 * @Nested
	 * 
	 * @DisplayName("Save methods") class ProductsubcategorySave {
	 * 
	 * @Test
	 * 
	 ...
	 * 
	 * assertNotNull(temp); assertNotSame(pc, temp, "No son el mismo objeto");
	 ...
	 * psc.setRowguid(666); pc.setProductcategoryid(13);
	 * 
	 * when(productcategoryRepository.findById(13)).thenReturn(Optional.of(pc));
	 ...
	 * productsubcategoryService.save(psc); }); try { Productsubcategory temp =
	 * productsubcategoryService.save(psc); assertNull(temp); } catch
	 * (RuntimeException rte) { rte.printStackTrace(); }
	 * 
	 * }
	 * 
	 * @Test
	 ...
	 * );
	 * 
	 * try { Productsubcategory temp = productsubcategoryService.save(psc);
	 * assertNull(temp); } catch (Exception e) { e.printStackTrace(); }
	 * 
	 * }
	 * 
	 * @Test
	 ...
	 * @Nested
	 * 
	 * @DisplayName("Update methods") class ProductsubcategoryUpdate {
	 * 
	 * @Test
	 * 
	 * @Order(5) void updateCorrectly() { psc.setModifieddate(time);
	 * psc.setName("Estano"); psc.setProducts(null);
	 * psc.setProductsubcategoryid(985); psc.setRowguid(666);
	 * 
	 * pc.setProductcategoryid(13);
	 * 
	 ...
	 * //assertNotNull(temp); assertFalse(temp.getName().isEmpty());
	 * assertEquals("Estano", temp.getName()); assertNotNull(temp);
	 ...
	 * @Test
	 * 
	 * @Order(6) void updateNameLesserThanFiveChar() { psc.setModifieddate(time);
	 * psc.setName("Sn"); psc.setProducts(null); psc.setProductsubcategoryid(985);
	 * psc.setRowguid(666); pc.setProductcategoryid(13);
	 * 
	 * when(productcategoryRepository.findById(13)).thenReturn(Optional.of(pc));
	 * when(productsubcategoryRepository.findById(985)).thenThrow(RuntimeException.
	 * class);
	 * 
	 * assertThrows(RuntimeException.class, () -> {
	 * productsubcategoryService.edit(psc); }); try { Productsubcategory temp =
	 * productsubcategoryRepository.findById(985).get(); assertNull(temp); } catch
	 * (RuntimeException rte) { rte.printStackTrace(); }
	 * 
	 * }
	 * 
	 * @Test
	 * 
	 * @Order(7) void updateNullProductcategoryid() { psc.setModifieddate(time);
	 * psc.setName("Estano"); psc.setProducts(null);
	 * psc.setProductsubcategoryid(985); psc.setRowguid(666);
	 * 
	 ...
	 * @Test
	 * 
	 * @Order(8) public void udateNull() { assertThrows(NullPointerException.class,
	 * () -> { productsubcategoryService.edit(null); }); } }
	 * 
	 * @AfterEach void tearDown() { psc = null; pc = null; System.gc(); }
	 * 
